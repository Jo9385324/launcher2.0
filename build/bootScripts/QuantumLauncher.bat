...
set JARPATH=%APP_HOME%\lib\QuantumLauncher-1.0.0-SNAPSHOT.jar

@rem Execute QuantumLauncher
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %QUANTUM_LAUNCHER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%QUANTUM_LAUNCHER_EXIT_CONSOLE%" exit 1
exit /b 1
